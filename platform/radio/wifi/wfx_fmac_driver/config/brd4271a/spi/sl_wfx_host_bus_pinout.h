...
// <eusart signal=TX,RX,CLK,CS> SL_WFX_HOST_PINOUT_SPI
// $[EUSART_SL_WFX_HOST_PINOUT_SPI]
...
#define SL_WFX_HOST_PINOUT_SPI_CS_PORT            gpioPortB
#define SL_WFX_HOST_PINOUT_SPI_CS_PIN             4
