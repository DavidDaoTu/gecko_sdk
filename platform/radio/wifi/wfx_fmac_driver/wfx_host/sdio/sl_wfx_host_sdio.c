...
static void sdio_irq_callback(void)
{
  // xSemaphoreGiveFromISR((SemaphoreHandle_t)sl_wfx_wakeup_sem, &xHigherPriorityTaskWoken);
  // xEventGroupSetBitsFromISR((EventGroupHandle_t)sl_wfx_bus_events, 2, &xHigherPriorityTaskWoken);
